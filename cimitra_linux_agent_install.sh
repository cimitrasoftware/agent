...
echo "CIMITRA_SERVER_ADMIN_ACCOUNT_SPECIFIED = $CIMITRA_SERVER_ADMIN_ACCOUNT_SPECIFIED"
echo "CIMITRA_SERVER_ADMIN_ACCOUNT = $CIMITRA_SERVER_ADMIN_ACCOUNT"

echo "CIMITRA_SERVER_ADDRESS_SPECIFIED = $CIMITRA_SERVER_ADDRESS_SPECIFIED"
echo "CIMITRA_SERVER_ADDRESS = $CIMITRA_SERVER_ADDRESS"
echo "CIMITRA_SERVER_PORT_SPECIFIED = $CIMITRA_SERVER_PORT_SPECIFIED"
echo "CIMITRA_SERVER_PORT = $CIMITRA_SERVER_PORT"
echo "CIMITRA_SERVER_ADMIN_PASSWORD_SPECIFIED = $CIMITRA_SERVER_ADMIN_PASSWORD_SPECIFIED"
echo "CIMITRA_SERVER_ADMIN_PASSWORD = $CIMITRA_SERVER_ADMIN_PASSWORD"
