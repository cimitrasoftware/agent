...
CALL_INFO "[ Cimitra Linux Agent Install Script ]"
...
echo "--- Script Help ---"
echo ""
echo -e "\e[41mCommon Usage: ${PROGRAM_NAME} 192.168.1.10 443 admin@cimitra.com myPassword \e[0m"
echo ""
echo "Install Cimitra Agent on Linux (No switches, No prompt for credentials method)"
echo ""
...
echo ""
echo "Install Cimitra Agent on Linux (No switches, Prompt for credentials method)"
echo ""
...
echo ""
echo "Install Cimitra Agent on Linux (Use switches, No prompt for credentials method)"
echo ""
...
echo ""
echo "Install Cimitra Agent on Linux (Use switches, Prompt for credentials method)"
echo ""
