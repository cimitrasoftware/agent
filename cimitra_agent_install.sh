...
then
	...
	if [ $OS_IS_MAC -eq 0 ]
	then
	sudo cimitra import -b -u ${CIMITRA_SERVER_ADMIN_ACCOUNT} -p ${CIMITRA_SERVER_ADMIN_PASSWORD} name="HOST INFO | AGENT: ${CIMITRA_AGENT_IN}"^ command=echo '[ Command: hostname ]' ";" hostname ";" echo ";" echo '[ Command: uname -a ]' ";" uname -a ";" echo ";" echo '[ Command: ip address show ]' ";" ip address show ";" echo '[ Command: lscpu ]' ";" echo ";" lscpu ";" echo '[ Command: lsblk ]' ";" echo ";" lsblk ";" echo '[ Command: df -hl ]' ";" echo ";" df -hl ";" echo '[ Command: top -bn1 ]' ";" echo ";" top -bn1^
	else
	sudo cimitra import -b -u ${CIMITRA_SERVER_ADMIN_ACCOUNT} -p ${CIMITRA_SERVER_ADMIN_PASSWORD} name="HOST INFO | AGENT: ${CIMITRA_AGENT_IN}"^ command=echo '[ Command: hostname ]' ";" hostname ";" echo ";" echo '[ Command: uname -a ]' ";" uname -a ";" echo ";" echo '[ Command: sysctl -n machdep.cpu.brand_string ]' ";" sysctl -n machdep.cpu.brand_string ";" echo ";" echo '[ Command: ifconfig ]' ";" ifconfig ";" echo '[ Command: sw_vers ]' ";" echo ";" sw_vers ";"  echo '[ Command: df -hl ]' ";" echo ";" df -hl^
	fi
fi
