...
Write-Host "ERROR: This script requires PowerShell $versionMinimum or greater" -ForegroundColor red -BackgroundColor white
Write-Output ""
exit 1
 }
...
Invoke-RestMethod -SkipCertificateCheck $CIMITRA_DOWNLOAD -OutFile $CIMITRA_DOWNLOAD_OUT_FILE -UseBasicParsing
